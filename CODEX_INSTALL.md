...
Read `config/chatgpt-skill-sources.json`, confirm stable release `v0.4.0`, and use the entry named `static-graphic-design-creator`. The canonical source directory is:
